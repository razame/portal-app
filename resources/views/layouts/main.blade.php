                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item menu-item-submenu menu-item-open menu-item-here" aria-haspopup="true" data-menu-toggle="hover">
                                                    ...
                                                    <div class="menu-submenu">
                                                        <i class="menu-arrow"></i>
                                                        <ul class="menu-subnav">
                                                            <li class="menu-item {{request()->route()->getName() === 'profileOverview' ? 'menu-item-active' : ''}}" aria-haspopup="true">
                                                                <a href="{{route('profileOverview')}}" class="menu-link">
                                                            ...
                                                            <li class="menu-item {{request()->route()->getName() === 'emailSettings' ? 'menu-item-active' : ''}}" aria-haspopup="true">
                                                                <a href="{{route('emailSettings')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                        <span></span>
                                                                    </i>
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="{{config('app.url')}}" target="_blank" class="text-dark-75 text-hover-primary">Portal App</a>
                    </div>
                    <!--end::Copyright-->
                </div>
                <!--end::Container-->
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="email navi-text text-muted text-hover-primary">{{session()->get('email')}}</span>
								</span>
                    </a>
...
@yield('scripts')
<script>
    function showAlert(divId, errors = []){

        if( errors.length !== 0 ){
            let errorsDiv = '<ul id="errors-list">';

            $.each(errors, function (key, item){
                errorsDiv += "<li>"+item+"</li>";
            });

            errorsDiv += "</ul>";

            $('#error-message-div > .p-1').append(errorsDiv);
        }
